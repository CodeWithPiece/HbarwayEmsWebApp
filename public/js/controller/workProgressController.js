app.controller('workProgressController', async function ($scope, $rootScope, $timeout, workProgressService) {
    ...
    $scope.searchDocument = async function () {
        let SerialNumber = '', ConsumerName = '', UserName = '';
        if ($scope.SerialNumber && $scope.SerialNumber !== 'undefined') {
            SerialNumber = $scope.SerialNumber;
        }
        if ($scope.ConsumerName && $scope.ConsumerName !== 'undefined') {
            ConsumerName = $scope.ConsumerName;
        }
        if ($scope.UserName && $scope.UserName !== 'undefined') {
            UserName = `${$scope.UserName}`;
        }
        await $scope.getUploadedDocuments(SerialNumber, ConsumerName, UserName);
    }
